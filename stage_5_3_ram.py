...
def run_and_monitor(sbatch_directory, max_jobs=22):
    ...
    while len(batch_jobs) > 0:
        ...
        if int(running) < max_jobs:
            ...
            os.system(f'mv {sbatch_directory}{batch_jobs[0]} /gpfs01/home/mbysh17/batch_files/stage_5_3_prorun/')

            os.system(f'echo "Moved file {batch_jobs[0]} to pro run folder"')

            # run another script
            os.system(f'sbatch /gpfs01/home/mbysh17/batch_files/stage_5_3_prorun/{batch_jobs[0]}')
        ...
        # when que gets to 1 or something (i.e. just this is running), send a greenlight for next step to run
            
# run the function on the directory containing the many batch files
# in this case thats the "bathc_files/parallel" folder
run_and_monitor('/gpfs01/home/mbysh17/batch_files/stage_5_3_prerun/')

...
pval_type_list=['AVERAGE_P','AVERAGE_PSNP8']
...
for phenotype in phenotype_list:
    ...
    for pval_type in pval_type_list:
        ...
        R_out.write(f'\n')
        if method_type=="GIFT":
            R_out.write(f'gwasResults<-read.csv("{PATH_TO_MAIN}output_files/R_DATA/{phenotype}_{method_type}_999_ALL.csv",header=TRUE)\n')

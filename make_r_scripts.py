...
Rscript_output.write('gwasResults<-read.csv("{args.p}_GWAS_{args.i}_{args.id}.csv",header=TRUE)\n')
...
Rscript_output.write('write.csv("{args.p}_GWAS_T20_SNPS_{args.i}_{args.id}.csv",row.names = FALSE)\n')
...
Rscript_output.write('png("{args.p}_GWAS_MANHATTAN_{args.i}_{args.id}.png", bg = "white", width = 9.75, height = 3.25, units = "in", res = 1200, pointsize = 4)\n')

...
def run_and_monitor(sbatch_directory, max_jobs=40):
    ...
    while len(batch_jobs) > 0:
        ...
        if int(running) < max_jobs:
            ...
            os.system(f'mv {sbatch_directory}{batch_jobs[0]} /gpfs01/home/mbysh17/batch_files/stage_4_prorun/')

            os.system(f'echo "Moved file {batch_jobs[0]} to pro run folder"')

            # run another script
            os.system(f'sbatch /gpfs01/home/mbysh17/batch_files/stage_4_prorun/{batch_jobs[0]}')
...
run_and_monitor('/gpfs01/home/mbysh17/batch_files/stage_4_prerun/')

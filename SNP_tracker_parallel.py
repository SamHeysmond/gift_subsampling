...
Mo98_ALL_SNPS_GIFT_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Mo98_ALL_SNPS_GIFT_df.csv")
...
Mo98_ALL_SNPS_GWAS_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Mo98_ALL_SNPS_GWAS_df.csv")
...
Na23_ALL_SNPS_GIFT_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Na23_ALL_SNPS_GIFT_df.csv")
...
Na23_ALL_SNPS_GIFT_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Na23_ALL_SNPS_GWAS_df.csv")
...
def process_csv_file(csv_file):
    ...
    if csv_file[2] == "Mo98" and csv_file[3]=='whole':
        ...
        #print(Current_Mo98_dataframe.head())
        ...
        ##########################
        # convert format of current csv to new format 
        temp_dataframe = Current_Mo98_dataframe.copy()
        #   changing the names of current columns
        temp_dataframe.rename(columns={CHR:'CHR',POS:'POS','pSNP4':'TOTAL_PSNP4','pSNP5':'TOTAL_PSNP5','absolute_theta':'TOTAL_ABS_THETA'}, inplace=True)
        # keep specific columns needed
        temp_dataframe=temp_dataframe[['CHR','POS','TOTAL_PSNP4','TOTAL_PSNP5','TOTAL_ABS_THETA']]
        ...
        # adding in two new columns at specific index values
        temp_dataframe.insert(2,"SUBSAMPLE_NUM",csv_file[6])
        temp_dataframe["TIMES_APPEARED"] = 1
        temp_dataframe["TOTAL_GIFT"] = Total_GIFT_Mo98
        # concatonate to the cumulative dataframe
        

        # READ THE DATA FROM CSV
        Mo98_ALL_SNPS_GIFT_df=pandas.read_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Mo98_ALL_SNPS_GIFT_df.csv")
        #GWAS_OR_GIFT_ALL_SNPS_df =pandas.concat([temp_dataframe,GWAS_OR_GIFT_ALL_SNPS_df], ignore_index=True)
        # testing the below code line
        Mo98_ALL_SNPS_GIFT_df=pandas.concat([Mo98_ALL_SNPS_GIFT_df,temp_dataframe],ignore_index=True)
        print("concat done")

        # group by and sort the data
        Mo98_ALL_SNPS_GIFT_df = Mo98_ALL_SNPS_GIFT_df.groupby(['CHR','POS','SUBSAMPLE_NUM'],as_index=False).agg({'TOTAL_PSNP4':'sum','TOTAL_PSNP5':'sum','TOTAL_ABS_THETA':'sum','TIMES_APPEARED':'sum','TOTAL_GIFT':'max'})
        print("groupby done")
        # SAVE TO CSV
        Mo98_ALL_SNPS_GIFT_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Mo98_ALL_SNPS_GIFT_df.csv")
        
        # delete variable to save memory
        del Mo98_ALL_SNPS_GIFT_df
        #############################
        ##########################
    ...
    # if statement 1.2     
        ...
        # adding in two new columns at specific index values
        temp_dataframe["TIMES_APPEARED"] = 1
        temp_dataframe["TOTAL_GWAS"] = Total_GWAS_Mo98
        temp_dataframe.insert(2,"SUBSAMPLE_NUM",csv_file[4])
        ...
        # READ THE DATA FROM CSV
        Mo98_ALL_SNPS_GWAS_df=pandas.read_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Mo98_ALL_SNPS_GWAS_df.csv")

        #GWAS_OR_GIFT_ALL_SNPS_df =pandas.concat([GWAS_OR_GIFT_ALL_SNPS_df,temp_dataframe], ignore_index=True)
        # testing this
        Mo98_ALL_SNPS_GWAS_df=pandas.concat([Mo98_ALL_SNPS_GWAS_df, temp_dataframe],ignore_index=True)
    
        print("concat done")
        # group by and sort the data
        Mo98_ALL_SNPS_GWAS_df = Mo98_ALL_SNPS_GWAS_df.groupby(['CHR','POS','SUBSAMPLE_NUM'],as_index=False).agg({'TOTAL_P':'sum','TIMES_APPEARED':'sum','TOTAL_GWAS':'max'})
        print("group by done")
        # WRITE TO CSV
        Mo98_ALL_SNPS_GWAS_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Mo98_ALL_SNPS_GWAS_df.csv")
    ...
    # if statement 1.3
        ...
        ##########################
        # convert format of current csv to new format 
        temp_dataframe = Current_Na23_dataframe.copy()
        #   changing the names of current columns
        temp_dataframe.rename(columns={CHR:'CHR',POS:'POS','pSNP4':'TOTAL_PSNP4','pSNP5':'TOTAL_PSNP5','absolute_theta':'TOTAL_ABS_THETA'}, inplace=True)
        # keep specific columns needed
        temp_dataframe=temp_dataframe[['CHR','POS','TOTAL_PSNP4','TOTAL_PSNP5','TOTAL_ABS_THETA']]
        ...
        temp_dataframe.insert(2,"SUBSAMPLE_NUM",csv_file[6])
        temp_dataframe["TIMES_APPEARED"] = 1
        temp_dataframe["TOTAL_GIFT"] = Total_GIFT_Na23
        # concatonate to the cumulative dataframe
        ...
        # READ THE DATA FROM CSV
        Na23_ALL_SNPS_GIFT_df=pandas.read_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Na23_ALL_SNPS_GIFT_df.csv")
        
        Na23_ALL_SNPS_GIFT_df=pandas.concat([Na23_ALL_SNPS_GIFT_df,temp_dataframe],ignore_index=True)
        
        # group by and sort the data
        Na23_ALL_SNPS_GIFT_df = Na23_ALL_SNPS_GIFT_df.groupby(['CHR','POS','SUBSAMPLE_NUM'],as_index=False).agg({'TOTAL_PSNP4':'sum','TOTAL_PSNP5':'sum','TOTAL_ABS_THETA':'sum','TIMES_APPEARED':'sum','TOTAL_GIFT':'max'})

        # write data to csv
        Na23_ALL_SNPS_GIFT_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Na23_ALL_SNPS_GIFT_df.csv")

        # delete variable to save memory
        del Na23_ALL_SNPS_GIFT_df
        #############################
        ##########################
    ...
    # if statement 1.4
        ...
        # adding in two new columns at specific index values
        temp_dataframe["TIMES_APPEARED"] = 1
        temp_dataframe["TOTAL_GWAS"] = Total_GWAS_Na23
        temp_dataframe.insert(2,"SUBSAMPLE_NUM",csv_file[4])
        ...
        # READ THE DATA FROM CSV
        Na23_ALL_SNPS_GWAS_df=pandas.read_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Na23_ALL_SNPS_GWAS_df.csv")

        #GWAS_OR_GIFT_ALL_SNPS_df =pandas.concat([GWAS_OR_GIFT_ALL_SNPS_df,temp_dataframe], ignore_index=True)
        # testing this

        Na23_ALL_SNPS_GWAS_df=pandas.concat([Na23_ALL_SNPS_GWAS_df, temp_dataframe],ignore_index=True)

        # group by and sort the data
        Na23_ALL_SNPS_GWAS_df = Na23_ALL_SNPS_GWAS_df.groupby(['CHR','POS','SUBSAMPLE_NUM'],as_index=False).agg({'TOTAL_P':'sum','TIMES_APPEARED':'sum','TOTAL_GWAS':'max'})

        # WRITE TO CSV
        Na23_ALL_SNPS_GWAS_df.to_csv("/mnt/c/users/sheys/OneDrive/LIFE_4137_ProjectDS/Project_DS_Files/Github/gift_subsampling/test_env/output_files/R_DATA/Na23_ALL_SNPS_GWAS_df.csv")
        #empty the variable to save memory
        del Na23_ALL_SNPS_GWAS_df
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    # almost worked? says "killed" so i guess memory is being overwritten somewhere...
    # or memory limit was reached?
    executor.map(process_csv_file,csv_files)

    #writing_results_idea2=[executor.submit(process_csv_file) for csv_file in csv_files]
...
print("head print test")
print(Na23_ALL_SNPS_GWAS_df.head())
print("///////////////////////////////")
####################################################
# IDEA 2.2 #####################################
############################################
